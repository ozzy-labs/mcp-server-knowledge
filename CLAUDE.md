...
- `/create` — 新規の knowledge 記事をトピック指定でリサーチ・執筆・登録
- `/update` — 既存の knowledge 記事を最新情報で再検証・更新（単体 / カテゴリ / `--stale` 指定）
- `/audit` — knowledge ベース全体の健全性を監査（frontmatter / INDEX / stale / リンク切れ / 重複 / 孤立）
