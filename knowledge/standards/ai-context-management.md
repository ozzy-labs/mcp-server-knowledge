...
- Anthropic: [Prompt Caching](https://platform.claude.com/docs/en/build/caching)
- Anthropic: [Extended Thinking best practices](https://platform.claude.com/docs/en/build/extended-thinking)
- Claude Code: Skills の progressive disclosure 仕様（`tools/claude-code.md` 参照）
- 本リポジトリの `standards/prompt-injection.md` — 信頼境界の設計はコンテキスト管理と密接
