...
| 2025-2026 | Routines / Codex cloud / Spec Kit / Kiro 等の orchestrator が登場 | autonomous workflow |
...
エージェントを**スケジュール / イベント / API トリガー**で起動し、人間の介在なしで PR を作成する形態。Claude Code Routines, Codex cloud（`@codex` GitHub bot / クラウド委譲タスク）, GitHub Copilot Coding Agent 等。詳細は `ai/practice/scheduled-tasks.md`。
