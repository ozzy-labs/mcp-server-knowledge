...
従来は各エージェントが固有のファイル名（`CLAUDE.md`, `.github/copilot-instructions.md`, `GEMINI.md`, `.cursorrules` 等）を要求していた。`AGENTS.md` は 2025 年にオープンな共通規約として提案され、主要 CLI エージェントが順次採用した。
...
| Cursor | `AGENTS.md` + `.cursor/rules/`（近年 `AGENTS.md` も公式サポート） |
