...
[kiro.dev/pricing](https://kiro.dev/pricing/) に最新プラン。GA（[2025-11-17 アナウンス](https://kiro.dev/blog/general-availability/)）後も Free（$0/月、50 credits/月、open-weight モデル + Claude Sonnet 4.5）が永続提供される。有料プランは Pro $20/月（1,000 credits）／ Pro+ $40/月（2,000 credits）／ Power $200/月（10,000 credits）。超過分は $0.04/credit、AWS GovCloud は約 20% 高。新規ユーザーが social login / Builder ID で初回有料アップグレード時に **$20 サインアップクレジット**、Students tier も提供（2026-03-18 開始）。Per-prompt クレジット消費が IDE 内で可視化される。
