...
| Models | Claude Sonnet 4.5 / Auto | Anthropic / OpenAI / Google, various | various |
...
5. **Not choosing a model and just relying on Auto mode** — Auto optimizes for speed and cost. For debugging / design review, explicitly specifying Claude Sonnet 4.5 gives more stable quality
