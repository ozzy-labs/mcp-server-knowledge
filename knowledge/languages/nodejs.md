...
- **`require(ESM)`**: v22.12 と v20.19 で `--experimental-require-module` がデフォルト ON 化し、**2026-04 時点で stable**。CJS から `require('./foo.mjs')` が可能。
